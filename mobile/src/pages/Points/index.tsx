...
import Emoji from 'react-native-emoji'; //https://unicodey.com/emoji-data/table.htm CATALOG FOR EMOTICONS
...
const Points = () => {
    ...
    useEffect(() =>{
        async function loadPosition(){
            ...
            if(status !== 'granted'){
                Alert.alert('Oooops...', 'Precisamos de suas permissão para obter sua localização');
                return;
            }
        ...
        <>
            <View style={styles.container}>
                ...
                <Text style={styles.title}>
                    <Emoji name=":grinning:" style={{ fontSize: 20, padding: 4 }} />
                    Bem vindo.
                </Text>
